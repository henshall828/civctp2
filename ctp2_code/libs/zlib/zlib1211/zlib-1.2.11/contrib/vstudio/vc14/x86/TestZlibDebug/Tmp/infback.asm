; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27040.0 
	...
	TITLE	G:\CtP2\zlib1211\zlib-1.2.11\infback.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
rtc$IMZ	ENDS
_DATA	SEGMENT
$SG7391	DB	'1.2.11', 00H
	ORG $+1
$SG7777	DB	'invalid block type', 00H
	ORG $+1
$SG7782	DB	'invalid stored block lengths', 00H
	ORG $+3
$SG7794	DB	'too many length or distance symbols', 00H
$SG7798	DB	'invalid code lengths set', 00H
	ORG $+3
$SG7809	DB	'invalid bit length repeat', 00H
	ORG $+2
$SG7817	DB	'invalid bit length repeat', 00H
	ORG $+2
$SG7820	DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG7822	DB	'invalid literal/lengths set', 00H
$SG7824	DB	'invalid distances set', 00H
	ORG $+2
$SG7840	DB	'invalid literal/length code', 00H
$SG7852	DB	'invalid distance code', 00H
	ORG $+2
$SG7857	DB	'invalid distance too far back', 00H
_DATA	ENDS
; Function compile flags: /Odtp /RTCsu
; File g:\ctp2\zlib1211\zlib-1.2.11\infback.c
_TEXT	SEGMENT
_state$ = 8						; size = 4
_fixedtables PROC
...
; 291  :         switch (state->mode) {
	...
	jmp	DWORD PTR $LN353@inflateBac[edx*4]
$LN255@inflateBac:
...
; 302  :             switch (BITS(2)) {
	...
	jmp	DWORD PTR $LN354@inflateBac[edx*4]
$LN259@inflateBac:
...
; 320  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7777
...
; 331  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7782
...
; 369  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7794
...
; 391  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG7798
...
; 414  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7809
...
; 437  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7817
...
; 451  :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7820
...
; 465  :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG7822
...
; 474  :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG7824
...
; 532  :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7840
...
; 564  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7852
...
; 579  :                 strm->msg = (char *)"invalid distance too far back";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7857
...
; 629  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN352@inflateBac
