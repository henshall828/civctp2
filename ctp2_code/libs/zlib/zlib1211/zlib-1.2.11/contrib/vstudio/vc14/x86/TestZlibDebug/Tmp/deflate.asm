; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27040.0 
	...
	TITLE	G:\CtP2\zlib1211\zlib-1.2.11\deflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File g:\ctp2\zlib1211\zlib-1.2.11\deflate.c
_TEXT	SEGMENT
tv78 = -48						; size = 4
_scan_end$ = -42					; size = 1
_scan_end1$ = -41					; size = 1
_strend$ = -40						; size = 4
_wmask$ = -36						; size = 4
_prev$ = -32						; size = 4
_limit$ = -28						; size = 4
_nice_match$ = -24					; size = 4
_best_len$ = -20					; size = 4
_len$ = -16						; size = 4
_match$ = -12						; size = 4
_scan$ = -8						; size = 4
_chain_length$ = -4					; size = 4
_s$ = 8							; size = 4
...
; 1987 :             uInt max_insert = s->strstart + s->lookahead - MIN_MATCH;
	...
	mov	DWORD PTR _max_insert$5[ebp], edx
...
; 1992 :             _tr_tally_dist(s, s->strstart -1 - s->prev_match,
	...
	mov	cx, WORD PTR _dist$3[ebp]
	mov	WORD PTR [edx+eax*2], cx
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+5792]
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+5784]
	mov	cl, BYTE PTR _len$4[ebp]
	...
	movzx	edx, WORD PTR _dist$3[ebp]
...
; 1539 :             uInt str = s->strstart - s->insert;
	...
	mov	DWORD PTR _str$3[ebp], ecx

; 1540 :             s->ins_h = s->window[str];

	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+56]
	mov	ecx, DWORD PTR _str$3[ebp]
...
; 820  :             level_flags = 0;
	...
	mov	DWORD PTR _level_flags$9[ebp], 0
...
; 822  :             level_flags = 1;
	...
	mov	DWORD PTR _level_flags$9[ebp], 1
	jmp	SHORT $LN41@deflate
$LN43@deflate:
...
; 824  :             level_flags = 2;
	...
	mov	DWORD PTR _level_flags$9[ebp], 2
	jmp	SHORT $LN41@deflate
$LN45@deflate:
...
; 826  :             level_flags = 3;
	...
	mov	DWORD PTR _level_flags$9[ebp], 3
$LN41@deflate:

; 827  :         header |= (level_flags << 6);

	mov	ecx, DWORD PTR _level_flags$9[ebp]
	shl	ecx, 6
...
; 909  :                 HCRC_UPDATE(beg);
	...
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+20]
	cmp	ecx, DWORD PTR _beg$8[ebp]
	jbe	SHORT $LN4@deflate
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR _beg$8[ebp]
	push	eax
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	add	edx, DWORD PTR _beg$8[ebp]
	push	edx
	mov	eax, DWORD PTR _strm$[ebp]
	mov	ecx, DWORD PTR [eax+48]
	push	ecx
...
; 917  :                 left -= copy;
	...
	mov	ecx, DWORD PTR _left$7[ebp]
	sub	ecx, DWORD PTR _copy$6[ebp]
	mov	DWORD PTR _left$7[ebp], ecx
...
; 955  :                     HCRC_UPDATE(beg);
	...
	mov	edx, DWORD PTR _s$[ebp]
	mov	eax, DWORD PTR [edx+20]
	sub	eax, DWORD PTR _beg$3[ebp]
	push	eax
	mov	ecx, DWORD PTR _s$[ebp]
	mov	edx, DWORD PTR [ecx+8]
	add	edx, DWORD PTR _beg$3[ebp]
	push	edx
	mov	eax, DWORD PTR _strm$[ebp]
	mov	ecx, DWORD PTR [eax+48]
	push	ecx
...
$LN125@deflate:
	...
	mov	DWORD PTR _bstate$1[ebp], edx
