; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27040.0 
	...
	TITLE	G:\CtP2\zlib1211\zlib-1.2.11\inftrees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File g:\ctp2\zlib1211\zlib-1.2.11\inftrees.c
_TEXT	SEGMENT
tv278 = -182						; size = 2
tv189 = -180						; size = 4
$T1 = -176						; size = 4
...
; 108  :         count[len] = 0;
	...
	jae	SHORT $LN66@inflate_ta
	jmp	SHORT $LN67@inflate_ta
$LN66@inflate_ta:
	call	___report_rangecheckfailure
$LN67@inflate_ta:
	xor	edx, edx
	mov	eax, DWORD PTR $T2[ebp]
	mov	WORD PTR _count$[ebp+eax], dx
...
; 141  :     offs[1] = 0;
	...
	jae	SHORT $LN68@inflate_ta
	jmp	SHORT $LN69@inflate_ta
$LN68@inflate_ta:
	call	___report_rangecheckfailure
$LN69@inflate_ta:
	xor	ecx, ecx
	mov	edx, DWORD PTR $T1[ebp]
	mov	WORD PTR _offs$[ebp+edx], cx
...
; 143  :         offs[len + 1] = offs[len] + count[len];
	...
	add	edx, ecx
	mov	eax, DWORD PTR _len$[ebp]
	mov	WORD PTR _offs$[ebp+eax*2+2], dx
...
; 252  :         if (--(count[len]) == 0) {
	...
	sub	cx, 1
	mov	WORD PTR tv278[ebp], cx
	mov	edx, DWORD PTR _len$[ebp]
	mov	ax, WORD PTR tv278[ebp]
	mov	WORD PTR _count$[ebp+edx*2], ax
	movzx	ecx, WORD PTR tv278[ebp]
	test	ecx, ecx
...
; 304  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN74@inflate_ta
