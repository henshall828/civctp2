; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27040.0 
	...
	TITLE	G:\CtP2\zlib1211\zlib-1.2.11\crc32.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_crc32
PUBLIC	_crc32_z
PUBLIC	_crc32_combine
PUBLIC	_get_crc_table
PUBLIC	_crc32_combine64
...
; File g:\ctp2\zlib1211\zlib-1.2.11\crc32.c
_TEXT	SEGMENT
_crc1$ = 8						; size = 4
_crc2$ = 12						; size = 4
_len2$ = 16						; size = 8
_crc32_combine64 PROC
...
; 425  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN17@crc32_comb
