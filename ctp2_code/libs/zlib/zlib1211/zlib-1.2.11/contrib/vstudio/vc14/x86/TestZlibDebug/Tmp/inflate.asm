; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27040.0 
	...
	TITLE	G:\CtP2\zlib1211\zlib-1.2.11\inflate.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
rtc$IMZ	ENDS
_DATA	SEGMENT
$SG7449	DB	'1.2.11', 00H
	ORG $+1
$SG8009	DB	'incorrect header check', 00H
	ORG $+1
$SG8011	DB	'unknown compression method', 00H
	ORG $+1
$SG8015	DB	'invalid window size', 00H
$SG8019	DB	'unknown compression method', 00H
	ORG $+1
$SG8021	DB	'unknown header flags set', 00H
	ORG $+3
$SG8068	DB	'header crc mismatch', 00H
$SG8085	DB	'invalid block type', 00H
	ORG $+1
$SG8089	DB	'invalid stored block lengths', 00H
	ORG $+3
$SG8101	DB	'too many length or distance symbols', 00H
$SG8105	DB	'invalid code lengths set', 00H
	ORG $+3
$SG8115	DB	'invalid bit length repeat', 00H
	ORG $+2
$SG8121	DB	'invalid bit length repeat', 00H
	ORG $+2
$SG8124	DB	'invalid code -- missing end-of-block', 00H
	ORG $+3
$SG8126	DB	'invalid literal/lengths set', 00H
$SG8128	DB	'invalid distances set', 00H
	ORG $+2
$SG8142	DB	'invalid literal/length code', 00H
$SG8153	DB	'invalid distance code', 00H
	ORG $+2
$SG8163	DB	'invalid distance too far back', 00H
	ORG $+2
$SG8176	DB	'incorrect data check', 00H
	ORG $+3
$SG8181	DB	'incorrect length check', 00H
_DATA	ENDS
; Function compile flags: /Odtp /RTCsu
; File g:\ctp2\zlib1211\zlib-1.2.11\inflate.c
_TEXT	SEGMENT
tv70 = -12						; size = 4
_next$ = -8						; size = 4
_got$ = -4						; size = 4
...
; 1441 : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN11@inflateSyn
...
; 656  :         switch (state->mode) {
	...
	jmp	DWORD PTR $LN530@inflate[edx*4]
$LN335@inflate:
...
; 681  :                 strm->msg = (char *)"incorrect header check";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG8009
...
; 686  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG8011
...
; 695  :                 strm->msg = (char *)"invalid window size";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8015
...
; 710  :                 strm->msg = (char *)"unknown compression method";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG8019
...
; 715  :                 strm->msg = (char *)"unknown header flags set";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8021
...
; 823  :                     strm->msg = (char *)"header crc mismatch";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG8068
...
; 860  :             switch (BITS(2)) {
	...
	jmp	DWORD PTR $LN531@inflate[edx*4]
$LN408@inflate:
...
; 882  :                 strm->msg = (char *)"invalid block type";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8085
...
; 891  :                 strm->msg = (char *)"invalid stored block lengths";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8089
...
; 930  :                 strm->msg = (char *)"too many length or distance symbols";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8101
...
; 952  :                 strm->msg = (char *)"invalid code lengths set";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG8105
...
; 975  :                             strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8115
...
; 998  :                         strm->msg = (char *)"invalid bit length repeat";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8121
...
; 1012 :                 strm->msg = (char *)"invalid code -- missing end-of-block";
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG8124
...
; 1026 :                 strm->msg = (char *)"invalid literal/lengths set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG8126
...
; 1035 :                 strm->msg = (char *)"invalid distances set";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG8128
...
; 1087 :                 strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG8142
...
; 1123 :                 strm->msg = (char *)"invalid distance code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG8153
...
; 1153 :                         strm->msg = (char *)"invalid distance too far back";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG8163
...
; 1212 :                     strm->msg = (char *)"incorrect data check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG8176
...
; 1225 :                     strm->msg = (char *)"incorrect length check";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG8181
...
; 1275 : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN529@inflate
	call	@_RTC_CheckStackVars@8
	pop	eax
	pop	edx
	pop	edi
