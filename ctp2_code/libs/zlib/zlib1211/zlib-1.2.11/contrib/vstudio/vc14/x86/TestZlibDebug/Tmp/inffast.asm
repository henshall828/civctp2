; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27040.0 
	...
	TITLE	G:\CtP2\zlib1211\zlib-1.2.11\inffast.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
rtc$IMZ	ENDS
_DATA	SEGMENT
$SG7455	DB	'invalid distance too far back', 00H
	ORG $+2
$SG7470	DB	'invalid distance code', 00H
	ORG $+2
$SG7475	DB	'invalid literal/length code', 00H
_DATA	ENDS
; Function compile flags: /Odtp /RTCsu
; File g:\ctp2\zlib1211\zlib-1.2.11\inffast.c
_TEXT	SEGMENT
tv326 = -100						; size = 4
tv319 = -96						; size = 4
_from$ = -92						; size = 4
...
; 174  :                             strm->msg =
	...
	mov	ecx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [ecx+24], OFFSET $SG7455
...
; 271  :                 strm->msg = (char *)"invalid distance code";
	...
	mov	eax, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [eax+24], OFFSET $SG7470
...
; 286  :             strm->msg = (char *)"invalid literal/length code";
	...
	mov	edx, DWORD PTR _strm$[ebp]
	mov	DWORD PTR [edx+24], OFFSET $SG7475
...
; 307  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN64@inflate_fa
