; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27040.0 
	...
	TITLE	G:\CtP2\zlib1211\zlib-1.2.11\trees.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File g:\ctp2\zlib1211\zlib-1.2.11\trees.c
_TEXT	SEGMENT
_s$ = 8							; size = 4
_bi_flush PROC
...
; 769  :             do { send_code(s, curlen, s->bl_tree); } while (--count != 0);
	...
	movzx	edx, WORD PTR _val$15[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
...
; 773  :                 send_code(s, curlen, s->bl_tree); count--;
	...
	mov	eax, DWORD PTR _s$[ebp]
	movzx	ecx, WORD PTR [eax+edx*4+2686]
	mov	DWORD PTR _len$14[ebp], ecx
	mov	edx, 16					; 00000010H
	sub	edx, DWORD PTR _len$14[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	cmp	DWORD PTR [eax+5820], edx
	jle	$LN18@send_tree
	mov	ecx, DWORD PTR _curlen$[ebp]
	mov	edx, DWORD PTR _s$[ebp]
	movzx	eax, WORD PTR [edx+ecx*4+2684]
	mov	DWORD PTR _val$13[ebp], eax
	movzx	edx, WORD PTR _val$13[ebp]
	mov	eax, DWORD PTR _s$[ebp]
	mov	ecx, DWORD PTR [eax+5820]
	shl	edx, cl
	mov	ecx, DWORD PTR _s$[ebp]
...
; 605  : }
	...
	mov	ecx, ebp
	push	eax
	lea	edx, DWORD PTR $LN12@gen_codes
